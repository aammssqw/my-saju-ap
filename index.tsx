  ...
  return (
    <div className="max-w-md mx-auto px-6 py-12 min-h-screen flex flex-col items-center">
      ...
      <header className="text-center mb-16 relative w-full flex flex-col items-center no-print">
        ...
        <div className="relative flex items-center justify-center w-full h-24">
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-visible">
            <img 
              ...
              alt="Channel Logo" 
              className="w-44 h-44 object-contain opacity-40 scale-125"
        ...
        <p className="text-zinc-500 text-[10px] font-light uppercase tracking-widest relative z-10 mt-10">Master of Destiny & Harmony</p>
      </header>
          ...
          <form onSubmit={handleAnalyze} className="space-y-10">
            ...
            <div className="space-y-3 w-full flex flex-col items-center">
              ...
              <input 
                ...
                className="w-full bg-white/5 border border-white/10 p-5 rounded-2xl text-white outline-none focus:border-amber-500/50 transition-colors text-center text-lg appearance-none"
              />
            </div>
            
            {/* 태어난 시간 & 성별 - 겹침 방지를 위해 세로 스택 강화 */}
            ...
            >
              {isLoading ? '2026년 천기를 읽는 중...' : '올해 나의 운세 / 사주 확인하기'}
            </button>
          </form>
        </div>
      ) : (
